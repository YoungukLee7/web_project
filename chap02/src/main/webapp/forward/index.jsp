...
<body>
	...
	<ul>
		<li>사용자가 보낸 요청을 하나의 서블렛(또는 JSP)에서 처리하다가 
	...
	<ul>
		...
		<li>실제로 사용자의 웹 브라우저에서 새로운 요청을 만들어 보내기(주소창에 새 주소를 입력) <br>
	...
	<div>
	<a href="/chap02/forward/controller?name=hong&age=33">포워드를 통해 Page1 보내기</a>
	</div>
	
	<div>
	<a href="/chap02/redirect/controller?name=hong&age=33">리디렉트를 통해 Page1 보내기</a>
	</div>
